...
test("verify the product detail visibility on dashboard pagw", async({page})=>{

    await page.waitForTimeout(4000)
    //await db.products.nth(0).isVisible()
...
test("Verify if multiple products are getting aded to cart", async({page})=>{
